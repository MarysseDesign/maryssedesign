...
<div class="award-kicker">
  D&AD New Blood Awards · <b>Yellow Pencil Winner</b>
</div>
...
<div class="col-md-12 nopaddingbottom hide-mobile">
  <img
    class="fadein reveal-media"
...
<div class="col-md-12 nopaddingbottom hide-mobile">
  <div class="award-video fadein reveal-media">
    <div class="video-embed">
      <iframe
        src="https://www.youtube.com/embed/ps4Pbe5pgNo?rel=0&modestbranding=1&showinfo=0&controls=1&iv_load_policy=3"
        title="GiffGaff — Back to the City"
        frameborder="0"
...
<div class="project-collaboration">
  ...
  <div class="project-team">
    <h2>Creative Team</h2> 
    <div class="team-rows">
      <a class="team-row" href="https://www.dandad.org/creative-community/directory/maria-zangone" target="_blank" rel="noreferrer noopener">
        <span class="team-name">Maria Assunta Zangone</span>
        <span class="team-arrow">→</span>
      </a>
<a class="team-row" href="https://www.dandad.org/creative-community/directory/patrizio-ranzani" target="_blank" rel="noreferrer noopener">
        <span class="team-name">Patrizio Ranzani</span>
        <span class="team-arrow">→</span>
      </a>
 <a class="team-row" href="https://www.dandad.org/creative-community/directory/lorenzo-lodi" target="_blank" rel="noreferrer noopener">
        <span class="team-name">Lorenzo Lodi</span>
        <span class="team-arrow">→</span>
      </a>
<a class="team-row" href="https://www.instagram.com/pazienza.ai/" target="_blank" rel="noreferrer noopener">
        <span class="team-name">Riccardo Palmieri</span>
        <span class="team-arrow">→</span>
      </a>
<a class="team-row" href="https://www.instagram.com/mattiagoose/?hl=am-et" target="_blank" rel="noreferrer noopener">
        <span class="team-name">Mattia Gosetti</span>
        <span class="team-arrow">→</span>
      </a>
    </div>
  ...
  <div class="project-tutors">
    <h2>Tutorship &amp; Academic Support</h2>

 <div class="team-rows">
      <a class="team-row" href="https://www.dandad.org/creative-community/directory/luca-riva" target="_blank" rel="noreferrer noopener">
        <span class="team-name">Luca Riva</span>
        <span class="team-arrow">→</span>
      </a>

<a class="team-row" href="https://www.ied.it/" target="_blank" rel="noreferrer noopener">
        <span class="team-name">Valentina Stucchi — IED · Istituto Europeo di Design</span>
        <span class="team-arrow">→</span>
      </a>
    </div>
