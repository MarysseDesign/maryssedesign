...
<div class="row mb-xl nopaddingbottom hide-mobile">
  <div class="col-md-12">
    <img
...
<div class="row mb-xl only-desktop-wide">
  <div class="col-md-12">
    <img
      ...
      src="/images/projects/portfolio/primolino/wide_01.jpg"
      alt="Primolino art direction wide set showcasing product styling and brand atmosphere."
      loading="lazy"
      decoding="async"
    />
  </div>
...
<div class="media-strip" aria-label="Website and e-commerce UI strip">
  ...
  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/web_01.jpg" alt="Website overview showing homepage structure and visual hierarchy." />
    </figure>

  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/web_02.jpg" alt="Website navigation and information architecture preview." />
    </figure>
   ...
   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/web_04.jpg" alt="Website editorial layout and content modules." />
    </figure>

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/web_05.jpg" alt="Primolino Casa product detail layout for e-commerce." />
    </figure>

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/web_06.jpg" alt="E-commerce shop experience showing product grid and navigation." />
    </figure>
...
<div class="row row-cols-2 mb-xl">
  <div class="col-md-12">
    <img
      class="fadein"
      src="/images/projects/portfolio/primolino/12.Primolino_logotyping.gif"
      alt="Primolino 2025 logo rebrand animation showing refinement of logotypes and monogram system."
      loading="lazy"
      decoding="async"
    />
  </div>
...
<div class="media-strip" aria-label="Monogram and packaging system strip">
  <div class="media-strip__track">

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/primolino-milano-logo.jpg" alt="Primolino Milano logotype." />
    </figure>

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/primolino-color-swatch.jpg" alt="Primolino Milano logotype on color swatch." />
    </figure>

  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/primolino-social-logo.jpg" alt="Primolino logotype applied to social media format." />
    </figure>

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/primolino-casa-label.jpg" alt="Primolino Casa label layout." />
    </figure>

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/P-Monogram.jpg" alt="Primolino P monogram." />
    </figure>

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/Shopping-Bag.jpg" alt="Primolino Casa shopping bag with monogram branding." />
    </figure>

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/P-packaging.jpg" alt="Primolino Casa packaging concept featuring the P monogram." />
    </figure>
...
<div class="row mb-xl nopaddingbottom">
  <div class="col-md-12">
    <img
      class="fadein reveal-media"
      src="/images/projects/portfolio/primolino/P-geometric-pattern.jpg"
      alt="Primolino geometric textile pattern developed for tablecloths and surface applications."
      loading="lazy"
      decoding="async"
    />
  </div>
...
<div class="media-strip" aria-label="Textile pattern collection strip">
  <div class="media-strip__track">

   <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/pattern-01.jpg" alt="Geometric textile pattern in orange colorway." />
    </figure>

  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/pattern-01-detail.jpg" alt="Geometric pattern detail in cream colorway." />
    </figure>

  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/pattern-02.jpg" alt="Heraldic pattern in earth-toned palette." />
    </figure>

  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/pattern-02-detail.jpg" alt="Heraldic pattern detail for textile application." />
    </figure>

  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/pattern-03.jpg" alt="Geometric textile pattern in cream colorway." />
    </figure>

  <figure class="media-strip__item">
      <img loading="lazy" decoding="async" src="/images/projects/portfolio/primolino/pattern-04-detail.jpg" alt="Heraldic textile pattern shown on a napkin detail." />
    </figure>
